...
def test_update_no_recursion_range_minimum_range_update():
    A = [3, 5, 2, 11, 9, 6, 20, 8]
    seg = RangeMinimumRangeUpdate(A)
...
def test_query_no_recursion_range_minimum_range_update():
    A = [3, 5, 2, 11, 9, 1, 20, 8]
    seg = RangeMinimumRangeUpdate(A)
...
def test_get_range_minimum_range_update_no_recursion():
    A = [3, 5, 2, 11, 9, 1, 20, 8]
    seg = RangeMinimumRangeUpdate(A)
